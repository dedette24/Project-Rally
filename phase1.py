...
debut = (49.12432002019948, 1.4985392805941944)
fin = (49.14246604743383, 1.4995166227428378)
...
def recup_itineraire_complet(depart_coordonne, arrive_coordonne):
    ...
    for i in range(1, len(coordinates)-1):
        ...
        # Classification avec hystérésis pour éviter les oscillations
        # Nouvelle classification des virages pour rallye
    ...
    # Ajouter tous les points GPS (en noir) pour visualiser le tracé brut
    ...
    carte.save("carte_rally_avec_tous_points.html")
